// Copyright 2021 Hassan EzzAldeen
#include <gtest/gtest.h>
#include <vector>
#include <algorithm>
#include <utility>
#include "../../../modules/task_1/hassan_jarvis_alg/jarvis_alg.h"



TEST(Sequential_Test, test1) {
    std::vector<std::pair<int, int>> points = { {2, 2}, {7, 3}, {4, 7} };
    std::vector<std::pair<int, int>> res_ = { {2, 2}, {7, 3}, {4, 7} };

    std::vector<std::pair<int, int>> res = JarvisAlg(points);

    ASSERT_EQ(res, res_);
}

TEST(Sequential_Test, test2) {
